...
Keep posts original. Do not copy Oracle docs, screenshots, tables, release-note text, training material,
certification questions, My Oracle Support content, or client data. The learner-facing site is designed
to avoid public Oracle documentation links.
